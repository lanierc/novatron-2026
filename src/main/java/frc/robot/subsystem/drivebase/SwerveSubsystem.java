...
public class SwerveSubsystem extends SubsystemBase {
  ...
  public SwerveSubsystem(File directory) {
    ...
    try {
      swerveDrive = new SwerveParser(directory).createSwerveDrive(SwerveConstants.maxSpeed,
          new Pose2d(2, 3, new Rotation2d(0)));
    } catch (Exception e) {
      throw new RuntimeException(e);
    }
    swerveDrive.setHeadingCorrection(false);
    swerveDrive.setCosineCompensator(!SwerveDriveTelemetry.isSimulation);
    // swerveDrive.setAngularVelocityCompensation(true, true, 0.5); // degisebilir
    ...
    try {
      ...
      AutoBuilder.configure(
          ...
          new PPHolonomicDriveController(
              new PIDConstants(3.1, 0, 0.0001), // Translation PID constants 0.8 0.0001
              new PIDConstants(4.8, 0, 0.0, 0.0) // Rotation PID constants 4.8
          ),
          config,
          () -> {
  ...
  public void resetOdometryToInitalPose() {
